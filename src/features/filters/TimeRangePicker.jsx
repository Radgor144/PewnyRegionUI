    ...
    return (
        <div className="bg-slate-100/70 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200/80 dark:border-slate-700/50 transition-colors">
            ...
            <div className="dual-range-slider" onClick={handleTrackClick}>
                ...
                <input type="range" min={minYear} max={maxYear} value={yearFrom} onChange={handleMinChange} className="z-10" />
                <input type="range" min={minYear} max={maxYear} value={yearTo} onChange={handleMaxChange} className="z-20" />
            </div>
