...
export const TopBar = () => {
    return (
        <header className="h-12 flex items-center justify-between px-4 sm:px-6 bg-white dark:bg-canvas-dark border-b border-slate-200 dark:border-slate-800 z-[60] shrink-0 transition-colors">
